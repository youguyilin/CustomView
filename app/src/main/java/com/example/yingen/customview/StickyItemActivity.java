...
import com.example.yingen.customview.adapter.PerformerAdapter;
import com.example.yingen.customview.view.StickyItemDecoration;
...
public class StickyItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new PerformerAdapter(this,getData()));
    }


    public List<Performer> getData() {
